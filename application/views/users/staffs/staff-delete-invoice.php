    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel19">Delete Information</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="delete-confirm" name="delete-confirm">Confirm</button>

<!-- Modal -->
<div class="modal" id="staticBackdrop03" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel03">My Account</h5>
...
$(function () {
	const loadProfileInfo = async () => {
        const { data } = await $.ajax(getAjaxConfig("/staff/profile/get-info/", {
            type: "GET"
        }));
    ...
    $(document).on("submit", "#profile-update-form", async function(event) {
        ...
        try {
			const { message } = await $.ajax(
				getAjaxConfig(`/staff/profile/${getLocalData().data.users_id}`, {
					type: "PUT",
					data: formData,
					contentType: false,
					processData: false,

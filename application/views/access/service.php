                    ...
                    <div class="card card-pricing">
                        <div class="card-body text-center">
                            ...
                            <ul class="card-pricing-features">
                               <tr>
                                <td width="70%"></td>
                                <p class="text-justify" text-align="justify" id="services_description" name="services_description">This is by far the most common reason people visit the dentist. <br>Many dentists recommend a cleaning every six months, and some recommend once a year. 
                                  Either way, it’s a very important part of oral health. Your own toothbrush will never be as efficient as the tools a dentist uses to clean your teeth.<br>
                    ...
                    <div class="card card-pricing">
                        <div class="card-body text-center">
                            ...
                            <ul class="card-pricing-features">
                               <tr>
                                <td width="70"></td>
                                <p class="text-justify" id="services_description" name="services_description">Like cleaning, whitening is a relatively discomfort-less process. Some people are sensitive to the whitening agents used, but otherwise it’s an easy procedure 
                    ...
                    <div class="card card-pricing">
                        <div class="card-body text-center">
                            ...
                            <ul class="card-pricing-features">
                               <tr>
                                <td width="70%" ></td>
                                <p class="text-justify" id="services_description" name="services_description">Extractions sound scary and painful. Admittedly, they are not the most pleasant of procedures. 
                    ...
                    <div class="card card-pricing">
                        <div class="card-body text-center">
                            ...
                            <ul class="card-pricing-features">
                               <tr>
                                <td width="70%"></td>
                                <p class="text-justify" id="services_description" name="services_description">If your teeth are crooked or discoloured, your dentist might recommend veneers. These are very popular solutions to common tooth problems. 
                    ...
                    <div class="card card-pricing">
                        <div class="card-body text-center">
                            ...
                            <ul class="card-pricing-features">
                               <tr>
                                <td width="70%"></td>
                                <p class="text-justify" id="services_description" name="services_description">Cavities are all too common and all too easy to get. For most cavities, a filling is the recommended answer. 
                    ...
                    <div class="card card-pricing">
                        <div class="card-body text-center">
                            ...
                            <ul class="card-pricing-features">
                               <tr>
                                <td width="70%"></td>
                                <p class="text-justify" id="services_description" name="services_description">If your cavity is a little too big for a filling, or the top part of your tooth has decayed, a crown is the solution. 

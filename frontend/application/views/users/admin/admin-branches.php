<!DOCTYPE html>
    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
        ...
        <script src="<?php echo base_url('frontend/assets')?>/js/vendor/dataTablesBranches.bootstrap5.js"></script>
        ...
        <!-- demo app -->
        <script src="<?php echo base_url('frontend/assets')?>/js/pages/demo.branches.js"></script>
        <!-- end demo js-->

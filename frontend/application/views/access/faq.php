            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    ...
                    <ul class="navbar-nav me-auto align-items-center">
                        ...
                        <li class="nav-item mx-lg-1">
<<<<<<< HEAD:frontend/application/views/access/faq.php
...
=======
                        ...
                        <li class="nav-item mx-lg-1">
                            <a class="nav-link active" href="faaq">FAQ</a>
                        </li>
                        <li class="nav-item mx-lg-1">
                            <a class="nav-link" href="pages-register">Register</a>
>>>>>>> bbe8db7f1235102ac6aee6835c072b61cca02dd1:frontend/application/views/access/faaq.php
                        </li>
                    </ul>

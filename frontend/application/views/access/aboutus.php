            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            ...
                            <h1>About</h1>
                            <h7>Happy <span class="text-primary">Smile</span></h7>
                        </div>
                    </div>
                </div>
                <div class="row mt-2 py-5 align-items-center">
                    ...
                    <div class="col-lg-6 offset-lg-1">
                        ...
                        <p class="text-muted mt-3">HappySmile is committed to operate the best chain of dental clinics 
                            that delivers the highest quality dental care at the most affordable cost to our customers.</p>

                        <h1 class="fw-normal">Our Vision</h1>
                        <p class="text-muted mt-3"> At HappySmile, our vision is to be the most admired and preferred name in dental care through 
                            the clinics we build, the processes we establish, the people we employ, the customer service we deliver, the quality 
                            of products and services we provide and the overall experience we create for our customers.Our Values</p>
            ...
            <div class="container">
                <div class="row py-4">
                    <div class="col-lg-12">
                        <div class="text-center">
                            ...
                            <h1> <span class="text-primary">MEET THE TEAM</span></h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="text-center p-3">
                            <div class="avatar-xxl m-auto">
                             <img src="../assets/images/users/judell.jpg" alt="" class="rounded-circle" width="70%" height="auto">    
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="text-center p-3">
                        <div class="avatar-xxl m-auto">
                             <img src="../assets/images/users/Steph.jpg" alt="" class="rounded-circle" width="70%" height="auto">    
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="text-center p-3">
                        <div class="avatar-xxl m-auto">
                             <img src="../assets/images/users/Jm.jpg" alt="" class="rounded-circle" width="70%" height="auto">    
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="text-center p-3">
                        <div class="avatar-xxl m-auto">
                             <img src="../assets/images/users/jarret.jpg" alt="" class="rounded-circle" width="70%" height="auto">    
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="text-center p-3">
                        <div class="avatar-xxl m-auto">
                             <img src="../assets/images/users/Irish.jpg" alt="" class="rounded-circle" width="70%" height="auto">    
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="text-center p-3">
                        <div class="avatar-xxl m-auto">
                             <img src="../assets/images/users/LC.jpg" alt="" class="rounded-circle" width="70%" height="auto">    
                            </div>
